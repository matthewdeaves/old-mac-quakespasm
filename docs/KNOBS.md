...
| `r_shadow_distance`     | (default 0 = unlimited) | 512 | 512 | Pass C HIGH (Round v3 Task #10): elide shadow draws past N units from viewer. Engine default 0 preserves upstream; G4 sets 512 for ~4-7% on dlight-heavy demos. Lion mirror added Round v5 wrap pass 2 (2026-05-09) to free GMA 950 fillrate on demo3 1024 (was fillrate-bound at 44.90 fps with shadows + trilinear + aniso). Squared compare in `R_DrawShadows`. **imac-g5 (#69, 2026-09-25):** raised to 0 (unlimited), overriding the ppc970 baseline's 512 in `autoexec-imac-g5.cfg` — same-session A/B, demo3 1024 (native 1440x900): 87.55 fps both ways, zero measured cost at this class's ~3.5x floor margin. Scoped to imac-g5 only; the ppc970-baseline G5 towers (g5-panther/g5-tiger/g5-desktop/quad-tiger/quad-leopard) have no A/B data and stay at 512. |
