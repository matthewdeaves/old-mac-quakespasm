# QuakeSpasm PowerPC Optimization Plan (v1, archived)

> **STATUS: SUPERSEDED — historical record.** This document was the
> original plan covering Phase 0 (cvar tuning, ✅ shipped), Phase 1
> (`frsqrte`, ✅ shipped), and the original Phase 1.1 / 2 / 3 outline
> that has since been reworked. Hardware/toolchain notes here remain
> accurate. The active plan is at `../../PPC_PLAN.md`.
>
> Archived 2026-05-07.
