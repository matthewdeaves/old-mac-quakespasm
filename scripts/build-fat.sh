...
#      Parallel sub-builds would race on the build host's oldmac/quakespasm/src/Quake/
...
# that host's oldmac/quakespasm/src/Quake/ tree and the final lipo happens there, so letting
